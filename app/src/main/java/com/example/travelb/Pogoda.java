...
public class Pogoda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton buttonSamolot = (ImageButton) findViewById(R.id.samolot);
        buttonSamolot.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {

                try {
                    Intent intent = new Intent(Pogoda.this, Atrakcji.class);
